...
/**
 * The module that modifies the reserved stock for a given period or time
 * @param {integer} itemId - The id of the give item.
 * @param {integer} stock - The stock of the item.
 */
...
/**
 * A module that retrieves the reserved the stock for a given item.
 * @param {integer} itemId - The id of the item in consideration
  ...
  getCurrentReservedStockById(itemId)
    ...
    .then((reservedStock) => {
      productItem.currentQuantity =
        productItem.initiatialAvailabilableQuantity - reservedStock;
